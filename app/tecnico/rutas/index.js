...
export default function RutasTecnico() {
  ...
  const centrarMiUbicacion = () => {
    ...
    if (Platform.OS === 'android') {
      mapRef.current.animateCamera(
        {
          center: { latitude: ubicacion.latitude, longitude: ubicacion.longitude },
          zoom: 16,
        },
        { duration: 500 }
      );
  ...
  const filteredOrdenes = useMemo(() => {
    ...
    return ordenes.filter((o) =>
      [o.order_id, o.nombre_orden, o.direccion, o.cliente].join(' ').toLowerCase().includes(q)
    );
  }, [ordenes, query]);
    ...
    <View style={styles.container}>
      ...
      <View style={styles.mapWrapper}>
        ...
        {selectedOrden && (
          <View style={styles.selectedPill}>
            ...
            {!!selectedOrden?.cliente && (
              <Text style={styles.selectedPillSub} numberOfLines={1}>
                {selectedOrden.cliente}
              </Text>
            )}
          </View>
      ...
      <View style={[styles.sheet, sheetExpanded ? styles.sheetExpanded : styles.sheetCollapsed]}>
        ...
        <View style={styles.searchRow}>
          ...
          <TextInput
            placeholder="Buscar #, nombre, cliente o dirección"
          ...
          ListEmptyComponent={
            <View style={{ padding: 12, alignItems: 'center' }}>
              <Text style={{ color: FIORI.textMuted, fontSize: 12 }}>
                {loadingOrdenes ? 'Cargando...' : 'Sin resultados'}
              </Text>
            </View>
          }
        />
...
const styles = StyleSheet.create({
  ...
  loadingText: { color: FIORI.ink, fontSize: 12, fontWeight: '700' },
  ...
  selectedPillText: { color: FIORI.ink, fontSize: 12, fontWeight: '800' },
  selectedPillSub: { color: FIORI.textMuted, fontSize: 11, marginTop: 2, fontWeight: '600' },
  ...
  cardCliente: { color: FIORI.textMuted, fontSize: 12, marginBottom: 6, fontWeight: '600' },
